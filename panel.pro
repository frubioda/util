pro Panel,xnr,ynr,nx=nx,ny=ny,reset=reset,xlabel=xlabel,ylabel=ylabel,$
          xleft=xleft,xright=xright,ybottom=ybottom,ytop=ytop,$
          xdist=xdist,ydist=ydist,order=order
;+
;   panel,xnr,ynr,nx=nx,ny=ny,reset=reset,xlabel=xlabel,ylabel=ylabel,$
;          xleft=xleft,xright=xright,ybottom=ybottom,ytop=ytop,$
;          xdist=xdist,ydist=ydist,order=order
;
...
;            xlabel and ylabel
;            order=order  1 for filling columns first (default), 0 otherwise
;-
...
if(n_params(0) lt 2) then begin
  print,'panel,xnr,ynr,nx=nx,ny=ny,reset=reset,xlabel=xlabel,ylabel=ylabel,$'
...
if(xnr eq 0) and (ynr eq 0) then begin
  calc_margin,xmargin,nx,xleft=xleft,xright=xright,xdist=xdist
  calc_margin,ymargin,ny,xleft=ybottom,xright=ytop,xdist=ydist
